 ...
 .then((response) => {
  ...
  <div class="card-header">
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">Email Address: <a href="${manager.email}">${manager.email}</a></li>
...
function internInfo() {
  inquirer
   ...
   <ul class="list-group list-group-flush">
     ...
     <li class="list-group-item">Email Address: <a href="${intern.email}">${intern.email}</a></li>
    ...
    inquirer
     ...
     .then((response) => {
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">Email Address: <a href="${engineer.email}">${engineer.email}</a></li>
